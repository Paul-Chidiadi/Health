...
<?php include 'includes/header.php'; ?>
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <div class="row">
                ...
                <div class="inner">
                  <?php
                    ...
                    if ($total === 0) {
                      ...
                      $sql = "SELECT * FROM attendance WHERE check_one != ''";
                      $query = $conn->query($sql);
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                <div class="inner">
                  <?php
                    $sql = "SELECT * FROM attendance WHERE date = '$today' AND time_in <= '08.00'";
                    $query = $conn->query($sql);
    ...
    <?php
      ...
      $late = array();
      for( $m = 1; $m <= 12; $m++ ) {
        $sql = "SELECT * FROM attendance WHERE MONTH(date) = '$m' AND time_in <= '08.00' $and";
